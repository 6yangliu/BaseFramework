...
- (void)viewDidLoad {
    ...
    [topView setBackgroundColor:[SXColorScheme getColor:COLOR_NavColor]];
    
    //返回
    UIImageView *backImageView = [[UIImageView alloc] initWithFrame:CGRectMake(20, 35, 14, 14)];
    [backImageView setImage:[UIImage imageNamed:@"nav_left"]];
    ...
    //背景
    [self.view setBackgroundColor:[SXColorScheme getColor:COLOR_ThemeColor]];
...
-(void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText{
    ...
    searchController.searchResultsTableView.frame = CGRectMake(0, 64, kScreen_width, kScreen_height-64);
