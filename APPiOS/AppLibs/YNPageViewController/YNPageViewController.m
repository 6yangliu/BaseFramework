...
/**
 ...
 @param config 配置信息
 */
- (void)startLoadPage:(NSArray *)controllers
...
- (void)initPageViewControllerWithControllers:(NSArray *)controllers
                                               titles:(NSArray *)titles
                                               config:(YNPageConfigration *)config {
...
- (void)setupPageScrollView {
    ...
    CGFloat contentHeight = kYNPAGE_SCREEN_HEIGHT - navHeight - tabHeight-self.bottomOffset;
    if ([self isSuspensionTopPauseStyle]) {
