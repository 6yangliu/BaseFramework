...
- (UIColor *)titleColor {
    if (!_titleColor) {
        _titleColor = [UIColor colorWithRed:143.0/255.0 green:157.0/255.0 blue:177.0/255.0 alpha:1];
    }
    return _titleColor;
}
...
- (UIColor *)titleSelectedColor {
    if (!_titleSelectedColor) {
        _titleSelectedColor = [UIColor colorWithRed:15.0/255.0 green:54.0/255.0 blue:83.0/255.0 alpha:1];
    }
...
- (UIColor *)indicatorColor {
    if (!_indicatorColor) {
        _indicatorColor = [UIColor colorWithRed:48.0/255.0 green:146.0/255.0 blue:252.0/255.0 alpha:1];
    }
...
- (UIColor *)verticalSeparatorColor {
    if (!_verticalSeparatorColor) {
        _verticalSeparatorColor = [UIColor colorWithRed:48.0/255.0 green:146.0/255.0 blue:252.0/255.0 alpha:1];
    }
